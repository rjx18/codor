// harn:assume relay-control-vocabulary-is-canonical ref=relay-control-source
// CANONICAL relay cleartext control vocabulary (PLAN §4.1) for the Worker and
// both Durable Objects. packages/tunnel/src/control.ts mirrors this for clients
// (it cannot import this dependency-free package); the two files are a pair and
// every value here MUST match that mirror exactly.
