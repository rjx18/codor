...
assert.equal(rootManifest.version, '0.10.14-alpha.8', 'the release candidate must advance to 0.10.14-alpha.8');
...
assert.match(acpAdapterSource, /clientInfo:\s*\{\s*name: 'Codor', version: '0\.10\.14-alpha\.8'/);
