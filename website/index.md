...
<div class="wr-landing">
  ...
  <section class="wr-principles" aria-label="Product principles">
    <article>
      <span>01</span>
      <h2>Sessions are members</h2>
      <p>Name the work, not the vendor. Each agent remains independently resumable and accountable.</p>
    </article>
    <article>
      <span>02</span>
      <h2>Runs stay readable</h2>
      <p>Live evidence expands when needed, then lands as one permanent message in the conversation.</p>
    </article>
    <article>
      <span>03</span>
  ...
  <section class="wr-open" aria-labelledby="open-title">
    <p class="wr-kicker">Open by construction</p>
    <h2 id="open-title">Self-host the complete solo product.</h2>
    <p>The switchboard, adapters, web PWA, protocol, relay, and bridges are MIT licensed. Hosted services sell operational convenience, never access to your content.</p>
